...
export const AVAILABLE_ITEM_IMAGE_FILENAMES = [
    ...
    'sceptre_of_lyf_empty.png', 'sceptre_of_lyf_full.png',
    ...
    'snake_staff_empty.png', 'snake_staff_full.png',
    'solid_key.png', 'speedbow.png', 'square_key.png', 'staff.png', 'staff_of_claws_empty.png',
    'staff_of_claws_full.png', 'staff_of_manar.png', 'staff_of_manar_empty.png', 'staff_of_manar_full.png',
    'stick.png', 'stone_club.png', 'stormring_empty.png',
    'stormring_full.png', 'suede_boots.png', 'suede_doublet.png', 'sword.png', 'tabard.png',
    'teowand.png', 'teowand_empty.png', 'teowand_full.png', 'the_conduit.png', 'the_firestaff.png',
    'the_firestaff_complete.png', 'the_hellion.png',
    ...
    'wand.png', 'wand_empty.png', 'wand_full.png', 'water.png', 'waterskin_empty.png', 'water_flask.png',
    'water_waterskin_full.png', 'winged_key.png', 'wooden_shield.png', 'worm_round.png', 'ya_potion.png',
    'yew_staff.png', 'yew_staff_empty.png', 'yew_staff_full.png',

...
const VISUALS_BY_NAME: Record<string, OverlayVisual> = {
    ...
    'Dent 1': { image: SOURCE_BACKED_WALL_OVERLAY_IMAGE_BY_NAME['Dent 1'], accent: '#8a857d', width: 0.16, height: 0.28 },
    ...
    'Scratches': { image: SOURCE_BACKED_WALL_OVERLAY_IMAGE_BY_NAME['Scratches'], accent: '#8c8578', width: 0.3, height: 0.27 },
    ...
    'Crack': { image: SOURCE_BACKED_WALL_OVERLAY_IMAGE_BY_NAME['Crack'], accent: '#8e8f9b', width: 0.26, height: 0.34 },
    'Iron Ring': { image: SOURCE_BACKED_WALL_OVERLAY_IMAGE_BY_NAME['Iron Ring'], accent: '#a0a0a6', width: 0.2, height: 0.2 },
    'Manacles': { image: SOURCE_BACKED_WALL_OVERLAY_IMAGE_BY_NAME['Manacles'], accent: '#9c9aa4', width: 0.5, height: 0.3 },

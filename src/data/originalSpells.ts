...
export const ORIGINAL_SPELLS: OriginalSpellDescriptor[] = [
    ...
    descriptor('ful,bro,ku', 'Strength Potion', '0x00697072', 4, 13, 1, 7, 15),
    ...
    descriptor('ya,bro', 'Shield Potion', '0x00667000', 2, 15, 1, 12, 25),
    descriptor('ya', 'Stamina Potion', '0x00660000', 2, 13, 1, 11, 15),
    descriptor('ya,bro,dain', 'Wisdom Potion', '0x00667074', 4, 13, 1, 8, 15),
    descriptor('ya,bro,neta', 'Vitality Potion', '0x00667075', 4, 13, 1, 9, 15),
    descriptor('vi', 'Health Potion', '0x00670000', 1, 13, 1, 14, 32),
    descriptor('vi,bro', 'Antivenin', '0x00677000', 1, 13, 1, 10, 26),
    descriptor('oh,bro,ros', 'Dexterity Potion', '0x00687073', 4, 13, 1, 6, 15),
    descriptor('zo,bro,ra', 'Mana Potion', '0x006b7076', 3, 2, 1, 13, 63),
    descriptor('zo,ven', 'Poison Potion', '0x006b6c76', 2, 19, 1, 3, 30),

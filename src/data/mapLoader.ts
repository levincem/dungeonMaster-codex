// Map loader - parses the runtime dungeon snapshot into typed GameMap objects.
// Runtime canonical data now lives in src/assets/data/, generated by the
// extraction pipeline and preloaded through dungeonData.ts.

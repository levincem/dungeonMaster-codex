...
function main() {
  ...
  const exportData = {
    ...
    woundDefenseFactors: decoded.byte1412,
    underscoreCharacterString: decoded.byte1414,
    renameChampionInputCharacterString: decoded.byte1416,
    reincarnateSpecialCharacters: decoded.specialChars,
